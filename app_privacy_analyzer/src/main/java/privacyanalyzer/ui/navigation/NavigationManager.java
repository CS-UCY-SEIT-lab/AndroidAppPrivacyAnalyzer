package privacyanalyzer.ui.navigation;
...
public class NavigationManager extends SpringNavigator {
	...
	public void navigateToDefaultView() {
		...
		// navigateTo(SecurityUtils.isCurrentUserInRole(Role.ADMIN) ? AnalyzeView.class
		// : AnalyzeView.class);
		navigateTo(AnalyzeView.class);
	}
	public void navigateToDefaultViewForce() {
	 ...
	 *
	 * @param parameter
	 *            the new parameter to set, never <code>null</code>, <code>""</code>
	 *            to not use any parameter
	 */
